...
public class Pverify_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_onaylayın.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    editText_kod.setHint("Hatalı Kod");
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            myRef.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    if (dataSnapshot.exists()){
                                        Intent register = new Intent(Pverify_page.this, Purpose_page.class);
                                        startActivity(register);
                                        finish();
                                    }else
                                    {
                                        Toast.makeText(Pverify_page.this,"Kod Onaylandı", Toast.LENGTH_SHORT).show();
                                        Intent register = new Intent(Pverify_page.this, Register_pages.class);
                        ...
                        {
                            Toast.makeText(Pverify_page.this,"Yanlış doğrulama kodu girdiniz!", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(Pverify_page.this,e.getMessage(),Toast.LENGTH_LONG).show();
        }
    };
